...

{
	...
	// INIT CAMS
	tyzxCams[0] =  new TyzxCam("192.168.247.41");
	if(CAM_CNT > 0) {
	tyzxCams[1] =  new TyzxCam("192.168.247.36");
	}
	...
	cloudConstructor = new CloudConstructor(tyzxCams, CAM_CNT);
