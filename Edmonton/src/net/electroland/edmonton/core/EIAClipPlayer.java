...
public class EIAClipPlayer {
	...
	public void introLocalTrill4Up(double x) {
		...
		anim.queueClipChange(trill2, null, null, 1.0, 1, 500, false); //popin
		anim.queueClipChange(trill3, null, null, 1.0, 1, 1500, false); //popin
		anim.queueClipChange(trill4, null, null, 1.0, 1, 2500, false); //popin
		
		/*
		 * 	anim.queueClipChange(trill2, null, null, 1.0, 0, 161, false); //popin
		anim.queueClipChange(trill3, null, null, 1.0, 0, 307, false); //popin
		anim.queueClipChange(trill4, null, null, 1.0, 0, 495, false); //popin
		 */
