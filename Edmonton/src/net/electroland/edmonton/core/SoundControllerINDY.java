...
public class SoundControllerINDY implements SCSoundControlNotifiable {
	...
	public SoundControllerINDY(int numOutputChannels, int numInputChannels, HashMap<String,String> systemProps){
