...
public class EIAClipPlayer2 extends EIAClipPlayer {
    ...
    public void boomerang(double x){
        ...
        Change out = new LinearChange().xTo(x-dist).scaleWidth(1.0);
        Change back = new LinearChange().xTo(x+lookAhead*2).scaleWidth(1.0).alphaTo(0.1);
    ...
    public void grow(double x){
        ...
        boomerang.queueChange(out,600).queueChange(back,600).fadeOut(100).delete();
    }
