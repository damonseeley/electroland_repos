...
public class ReadPhoenixDigitalTool extends JFrame implements Runnable  {
	...
	SensorPanelDigital sp;

	private MTMPhoenixDigitalThread mtmt;
	...
	static Logger logger = Logger.getLogger(ReadPhoenixDigitalTool.class);

	public ReadPhoenixDigitalTool() {
		...
		sp = new SensorPanelDigital(sensorWidth,sensorHeight);
		this.add(sp);
		...
		mtmt = new MTMPhoenixDigitalThread(startIP,startFramerate,sp);
	...
	public static void main(String[] args) {
		...
		ReadPhoenixDigitalTool eiait = new ReadPhoenixDigitalTool();
