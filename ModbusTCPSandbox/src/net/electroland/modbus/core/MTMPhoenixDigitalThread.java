...
public class MTMPhoenixDigitalThread  extends Thread {
	...
	public SensorPanelDigital sp;

	static Logger logger = Logger.getLogger(MTMPhoenixDigitalThread.class);
	...
	public MTMPhoenixDigitalThread(String ip, int fr, SensorPanelDigital sp) {
