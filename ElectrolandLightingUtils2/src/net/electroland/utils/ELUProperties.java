...
public class ELUProperties {
	...
	public static void main(String args[]){
		...
		try {
			ELUProperties op = new ELUProperties(p);
	 ...
	 * @param p
	 */
	public ELUProperties(Properties p) throws OptionException
	{
		this.objects = init(p);
	}
	 ...
	 * @param resourceName
	 */
	public ELUProperties(String resourceName) throws OptionException
	{
		Properties p = new Properties();
