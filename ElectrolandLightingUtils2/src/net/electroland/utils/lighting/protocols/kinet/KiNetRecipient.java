package net.electroland.utils.lighting.protocols.kinet;
...
public class KiNetRecipient extends Recipient {
    ...
    public void configure(ParameterMap properties) throws OptionException
    {
        ...
        if (this.portout < 1 || this.portout > 10)
        {
            throw new OptionException("recipient.portout must be between 1 and 10.");
        }
