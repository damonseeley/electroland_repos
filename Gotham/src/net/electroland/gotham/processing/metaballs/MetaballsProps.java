...
public class MetaballsProps implements ControlListener {
    ...
    final static public int BG_COLOR                   = 0;
    // DO NOT CHANGE ANY OF THESE: HASH KEYS!
    final static public String COHESIVENESS            = "cohesiveness";
    final static public String BALL_TO_BALL_REPELL     = "ballToBallRepell";
    final static public String REPELL_FORCE            = "repellForce";
    final static public String REPELL_VELOCITY_MULT    = "repellVelocityCoefficient"; // goes into presence impact
    final static public String JET_FORCE_SCALE         = "jetForceScale";
    final static public String WIND_FORCE_SCALE        = "windForceScale";
    ...
    final static public String MARGIN                  = "margin";
    final static public String HUE_VARIANCE            = "hueVariance"; // this cannot be controlled in real time.
    ...
    final static public String SHOW_WIND               = "showWind";
    ...
    public void controlEvent(ControlEvent arg0) {
        ...
        if (arg0.getController().getName().equals("console dump")) {
            ...
            System.out.println();
            ((Metaballs)parent).dumpStateToConsole();
            System.out.println();
        } else if (arg0.getController().getName().equals("reload")){
