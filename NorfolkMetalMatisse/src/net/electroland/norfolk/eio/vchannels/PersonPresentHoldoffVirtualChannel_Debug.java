...
public class PersonPresentHoldoffVirtualChannel_Debug extends VirtualChannel {
    ...
    public void configure(ParameterMap params) {
        ...
        personPresentHoldoffFilt = new HoldoffFilter_Debug();
    ...
    public Value processInputs(ValueSet inputValues) {
        ...
        Value presentHoldoff = new Value(0);
        ...
        if (personPresent) {
            ...
            personPresent = (personPresentVal.getValue() != Integer.MAX_VALUE);
            
            presentHoldoff.setValue( personPresentVal.getValue() );
//            if (!personPresent)
...
//                            System.out.println("CH " + id + " - PERSON EXITED (BY CLIP) AT " + ((double)System.currentTimeMillis() - startTimeMs)/1000);
        ...
        output.setValue( presentHoldoff.getValue() );
        return output;
    }
