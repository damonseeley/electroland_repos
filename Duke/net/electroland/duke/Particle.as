package net.electroland.duke {
	...
	public class Particle extends MovieClip{
		...
		*/
		...
		public function Particle(id:Number, emitterID:Number, x:Number, y:Number, radius:Number, mass:Number, spin:Number, visualMode:Number, particleSystem:ParticleSystem){
			this.id = id;
		...
		public function setVisualMode(visualMode:Number):void{
			...
			if(visualMode == 0){
				...
				bm = particleSystem.softParticle.content as Bitmap;
				...
				bm = particleSystem.weirdParticle.content as Bitmap;
				image = new Bitmap(bm.bitmapData);
				image.width = radius*2;
				image.height = radius*2;
				addChild(image);
