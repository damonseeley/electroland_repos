...
import net.electroland.elvis.regionManager.SettingsTab;
import net.electroland.elvis.util.ElProps;

public class RegionDesigner extends JFrame {
       
//	CreatorToolBar ctb;
	ImagePanel imagePanel; ;
	SettingsTab settings;
	
	public static RegionDesigner THE_FRAME;
	
	

	
	public RegionDesigner(ElProps props, int w, int h) throws SocketException, UnknownHostException {
		super("ElVis");
