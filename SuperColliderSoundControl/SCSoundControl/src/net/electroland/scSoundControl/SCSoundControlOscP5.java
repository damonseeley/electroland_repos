...
public class SCSoundControlOscP5 implements OscEventListener, Runnable {
    ...
    public SCSoundControlOscP5(SCSoundControlNotifiable listener) {
     ...
     */
    public SCSoundControlOscP5(SCSoundControlNotifiable listener, String propertiesFilename) {
...
/*
        ...
        try {
            _sender = new OSCPortOut(InetAddress.getLocalHost(), udpport); }
...
//            _receiver.close();
    ...
    /** OscP5 version of sending messages
     * 
     * @param addr
     * @param args
     */
    ...
    {
        OscPacket packet = new OscMessage(addr, args);
        oscConnection.send(packet);
    }
