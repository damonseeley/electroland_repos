...
//			newPosArgs[1] = newTheta + ""; //azimuth
//			newPosArgs[2] = 0 + ""; //elevation
//			newPosArgs[3] = newDist + ""; //distance in meters
...
//			String command = "SpatDIF/source/" + args[0] +"/aed " + args[1] + " " + args[2] + " " + args[3];
//			//logger.info("SEND TO SES: " + command);
//
//			Object argToSend[] = new Object[1]; //have to have this primitive for lame lib to work
//			argToSend[0] = "";
