...
public class MediumFish3 extends StandardFish {
//	FishPolyRegion fpr;
	public MediumFish3(Pond pond) {
		super(pond,1f, 3);
		this.species = FishIDs.MEDIUMFISH3_ID;
		...
		setSubFlock(this);
		maxSpeed.setSpeed(Util.plusOrMinus(FishProps.THE_FISH_PROPS.getProperty("MediumFish3MaxSpeed", 90), 10));
