...
public class TinyFish1 extends StandardFish {
	float buffersize = 300f;
	float zBuffersize = .1f;


	public TinyFish1(Pond pond) {
		super(pond, 1f, 6);// the last number is the flock/species
		this.species = FishIDs.TINYFISH1_ID;
		...
		maxSpeed.setSpeed(Util.plusOrMinus(FishProps.THE_FISH_PROPS.getProperty("TinyFish1MaxSpeed", 100), 20));
