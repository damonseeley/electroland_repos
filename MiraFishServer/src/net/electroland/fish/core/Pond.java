...
public class Pond extends Thread implements Drawable {
...
//	Timer timer;
	...
	public Pond(Bounds bounds, int xCellCnt, int yCellCnt) { // cell size should be 1/2 smallest view radius of boid
