...
final class LetterformPixelGrabber implements ImageObserver {
	...
	public LetterformPixelGrabber(Image img) {
		m_image = img;
	}
	...
	public void grabPixels() {
		...
		PixelGrabber pixelGrabber = new PixelGrabber(m_image, 0, 0, m_iWidth,
				m_iHeight, false);
	...
	public int getRGB(int pixel) {
		if ((m_colorModel instanceof IndexColorModel))
			...
			System.out
					.println(getRed(pixel) + getGreen(pixel) + getBlue(pixel));
		//return pixel;
		//DS MOD, turn this method into something useful for PNGs
