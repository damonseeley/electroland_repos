...
function OnServerInitialized(){
	Spawnplayer(Network.player);	//Spawn a player for the server itself
}

function OnPlayerConnected(newPlayer: NetworkPlayer) {
	Spawnplayer(newPlayer);	//A player connected to me(the server)!
}	

function Spawnplayer(newPlayer : NetworkPlayer){	//Called on the server only
