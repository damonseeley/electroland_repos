...
public class SESSoundControllerP5 {
	...
	private static Logger logger = Logger.getLogger(SESSoundControllerP5.class);

	public SESSoundControllerP5(String ip, int maxPort, int sesPort, int maxCh, Point2D.Double listenPos) {
